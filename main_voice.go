...
func main() {
	...
	for update := range updates {
		...
		if update.Message.IsCommand() {
			...
			case "start":
				msg := tgbotapi.NewMessage(update.Message.Chat.ID,
					"🎙️ Привет! Я голосовой бот с ChatGPT, ElevenLabs и доступом к БД!\n\n"+
						"✨ Что я умею:\n"+
						"🎤 Голос → GPT → Голос\n"+
						"📝 Текст → GPT → Голос\n"+
						"💾 База [запрос] → SQL → GPT → Голос\n"+
						"💭 Мысль [текст] → Сохранить в БД\n"+
						"🔊 /voice [текст] → Голос\n\n"+
						"Команды:\n"+
						"/voice [текст] - просто озвучить текст\n"+
						"/help - помощь\n\n"+
						"💡 Попробуйте:\n"+
						"• \"База сколько всего сообщений?\"\n"+
						"• \"Мысль изучить Go channels\"\n"+
						"• \"База покажи последние 3 мысли\"\n\n"+
			...
			case "help":
				msg := tgbotapi.NewMessage(update.Message.Chat.ID,
					"🎙️ Как я работаю:\n\n"+
						...
						"   → GPT форматирует результат\n"+
						"   → ElevenLabs озвучивает\n\n"+
						"   Примеры:\n"+
						"   • База сколько сообщений?\n"+
						"   • База покажи последние 3 записи\n"+
						"   • База сколько мыслей?\n"+
						"   • База последние 5 мыслей\n\n"+
						"4️⃣ 💭 МЫСЛЬ [текст]:\n"+
						"   → Сохраняет мысль/заметку в БД\n"+
						"   → Озвучивает подтверждение\n\n"+
						"   Примеры:\n"+
						"   • Мысль изучить Go channels\n"+
						"   • Мысль сделать рефакторинг кода\n"+
						"   • Мысль посмотреть курс по Docker\n\n"+
						"5️⃣ 🔊 /voice [текст]:\n"+
						...
						"💾 SQLite Database (messages + thoughts)")
				bot.Send(msg)
